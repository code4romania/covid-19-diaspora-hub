...
<h1>Diplomatic missions</h1>
<!-- START_76699d681f38e3c235a53f2380b5e53a -->
<h2>Get all diplomatic missions</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
<pre><code class="language-javascript">const url = new URL(
...
response.json()</code></pre>
<pre><code class="language-bash">curl -X GET \
    -G "http://localhost/api/v1/diplomatic-missions" </code></pre>
<blockquote>
<p>Example response (200):</p>
</blockquote>
<pre><code class="language-json">{
...
<h3>HTTP Request</h3>
<p><code>GET api/v1/diplomatic-missions</code></p>
