...
return [
    ...
    'routes' => [
        [
            ...
            /*
             * Specify rules to be applied to all the routes in this group when
            ...
            'apply' => [
                ...
                'response_calls' => [
                    /*
                     * API calls will be made only for routes in this group matching
                     * these HTTP methods (GET, POST, etc). List the methods here
                     * or use '*' to mean all methods. Leave empty to disable API
                     * calls.
                     */
                    'methods' => ['GET'],
